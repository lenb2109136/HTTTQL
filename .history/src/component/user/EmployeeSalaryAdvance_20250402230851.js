...
const EmployeeSalaryAdvance = () => {
  ...
  useEffect(() => {
    ...
    console.log('Raw employee data from localStorage:', employeeDataString); // Log raw data
    ...
    try {
      ...
      console.log('Parsed employee data:', employeeData); // Log parsed data
  ...
  const handleSubmit = async e => {
    ...
    // Log NV_ID and the entire payload before sending the request
