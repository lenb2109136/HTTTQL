...
const EmployeeHeader = () => {
  ...
  useEffect(() => {
    ...
    ws.onopen = () => {
      ...
      if (employee.NV_ID) {
        ws.send(`subscribe:${employee.NV_ID}`); // Subscribe với NV_ID
      }
    };
    ...
    ws.onerror = error => console.error('WebSocket error in Header:', error);
    ws.onclose = () => console.log('WebSocket disconnected in Header');
  ...
  const handleNotificationClick = notification => {
    ...
    navigate('/employee-salary-advance');
