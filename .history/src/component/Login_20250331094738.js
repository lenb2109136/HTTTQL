...
const LoginPage = () => {
  ...
  const handleSubmit = async e => {
    ...
    console.log('formData trước khi validate:', formData); // Debug trước validate
    ...
    console.log('Payload gửi đi:', payload); // Debug payload trước khi gửi
                ...
                <Form onSubmit={handleSubmit}>
                  <Form.Group className="mb-4" controlId="formIdentifier">
                    ...
                    <div className="input-wrapper">
                      ...
                      <Form.Control
                        type="text"
                        name="identifier" // Đảm bảo name khớp với key trong formData
                  ...
                  <Form.Group className="mb-4" controlId="formPassword">
                    ...
                    <div className="input-wrapper">
                      ...
                      <Form.Control
                        type="password"
                        name="NV_PASSWORD" // Đảm bảo name khớp với key trong formData
