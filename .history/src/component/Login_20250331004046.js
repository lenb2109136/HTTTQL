...
import './LoginPage.css'; // Custom CSS for Samsung-like styling
...
const LoginPage = () => {
  ...
  const handleSubmit = async e => {
    ...
    // Kiểm tra formData trước khi validate
    console.log('formData trước khi validate:', formData);
    ...
    // Tạo payload và kiểm tra trước khi gửi
    const payload = {
                ...
                <Form onSubmit={handleSubmit}>
                  <Form.Group className="mb-4" controlId="formIdentifier">
                    ...
                    <div className="input-wrapper">
                      ...
                      <Form.Control
                        type="text"
                        name="identifier" // Thêm name để handleInputChange hoạt động
                        placeholder="Email hoặc số điện thoại"
                        value={formData.identifier}
                        onChange={handleInputChange} // Sử dụng hàm chung
                  ...
                  <Form.Group className="mb-4" controlId="formPassword">
                    ...
                    <div className="input-wrapper">
                      ...
                      <Form.Control
                        type="password"
                        name="NV_PASSWORD" // Thêm name để handleInputChange hoạt động
