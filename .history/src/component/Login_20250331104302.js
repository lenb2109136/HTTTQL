...
const LoginPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.password) {
      newErrors.password = 'Mật khẩu là bắt buộc'; // Đổi từ NV_PASSWORD thành password
    }
    return newErrors;
  };
  ...
  const handleSubmit = async e => {
    ...
    // Kiểm tra bổ sung trước khi gửi
    ...
    const payload = {
      ...
      password: formData.password, // Đổi từ NV_PASSWORD thành password
    };
    ...
    try {
      ...
      if (
        ...
        response.data.NV_PASSWORD === formData.password // So sánh với NV_PASSWORD từ server
      ) {
                ...
                <Form onSubmit={handleSubmit}>
                  ...
                  <Form.Group className="mb-4" controlId="formPassword">
                    ...
                    <div className="input-wrapper">
                      ...
                      <Form.Control
                        type="password"
                        name="password" // Đổi từ NV_PASSWORD thành password
