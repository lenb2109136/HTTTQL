    ...
    try {
      ...
      if (response.data && response.data.NV_ID) {
        ...
        const employeeData = {
          ...
          NV_HOTEN: response.data.NV_HOTEN || 'Người dùng', // Đảm bảo có giá trị mặc định
          avatar:
            response.data.avatar ||
            'https://cdn-icons-png.flaticon.com/512/219/219986.png', // Giả sử server trả về avatar, nếu không thì dùng mặc định
        };
        ...
        toast.success('Đăng nhập thành công!', {
          position: 'top-right',
          autoClose: 2000,
          onClose: () => navigate('/userhome'), // Điều hướng sau khi toast đóng
        });
      } else {
