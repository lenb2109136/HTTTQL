...
const AdvanceSalaryPage = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      ...
      const payload = {
        ...formData,
        nv_ID: parseInt(formData.nv_ID), // Chuyển nv_ID thành int
        ul_TIEN: parseFloat(formData.ul_TIEN), // Đảm bảo ul_TIEN là số
            ...
            <Row>
              <Col md={6}>
                ...
                <Form.Group className="mb-3">
                  ...
                  <Form.Control
                    type="number"
                    min="1" // Ngăn nhập số âm trực tiếp trong input
                    step="1000" // Tăng/giảm theo bội số 1000
