...
const EmployeesPage = () => {
  ...
  const validateForm = () => {
    ...
    if (!formData.nv_PASSWORD && !editingEmployee) newErrors.nv_PASSWORD = 'Mật khẩu là bắt buộc';
  ...
  const handleSubmit = async e => {
    ...
    try {
      const payload = {
        ...
        pb_ID: { pb_ID: parseInt(formData.pb_ID) }, // Gửi pb_ID như một object
  ...
  const handleEdit = employee => {
    ...
    setFormData({
      ...
      nv_GIOITINH: employee.nv_GIOITINH === 1, // Chuyển 1/0 thành true/false
