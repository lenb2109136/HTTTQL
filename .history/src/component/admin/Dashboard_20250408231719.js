  ...
  return (
    <Container fluid className="p-4 bg-light min-vh-100">
      ...
      <Row className="g-4">
        ...
        {/* Biểu đồ Tỷ lệ khấu trừ và thu nhập với dropdown */}
        {hasDataForSelectedMonth && (
          <Col md={6}>
            <Card className="shadow border-0 rounded-3 chart-card h-100">
              <Card.Header className="py-3 bg-white border-bottom d-flex justify-content-between align-items-center">
                ...
                <div>
                  <Form.Group controlId="monthSelectDeduction" className="me-2">
                    <Form.Control
                      as="select"
                      value={selectedMonth}
                      onChange={e => setSelectedMonth(parseInt(e.target.value))}
                  ...
                  <Form.Group controlId="yearSelectDeduction">
                    <Form.Control
                      as="select"
                      value={selectedYear}
                      onChange={e => setSelectedYear(parseInt(e.target.value))}
              ...
              <Card.Body className="chart-body">
                {deductionRatioData ? (
                  <Pie
                    ...
                    options={{
                      ...deductionRatioData.options,
                      plugins: {
                        ...deductionRatioData.options.plugins,
                        title: {
                          display: true,
                          text: `Tỷ lệ khấu trừ và thu nhập (Tháng ${selectedMonth}/${selectedYear})`,
                        },
              ...
              <Card.Body className="chart-body">
                {monthlySalaryData ? (
                  <Bar
                    ...
                    options={{
                      ...monthlySalaryData.options,
                      plugins: {
                        ...monthlySalaryData.options.plugins,
                        title: {
                          display: true,
                          text: `Tổng lương theo tháng (Năm ${selectedYear})`,
                        },
        ...
        {/* Biểu đồ Lương thực nhận và khấu trừ theo phòng ban với dropdown */}
        {hasDataForSelectedMonth && (
          <Col md={12}>
            <Card className="shadow border-0 rounded-3 chart-card h-100">
              <Card.Header className="py-3 bg-white border-bottom d-flex justify-content-between align-items-center">
                ...
                <div>
                  <Form.Group
                    controlId="monthSelectSalaryVsDeduction"
                    className="me-2"
                  >
                    <Form.Control
                      as="select"
                  ...
                  <Form.Group controlId="yearSelectSalaryVsDeduction">
                    <Form.Control
                      as="select"
                      value={selectedYear}
                      onChange={e => setSelectedYear(parseInt(e.target.value))}
              ...
              <Card.Body className="chart-body">
                {salaryVsDeductionData ? (
                  <Bar
                    ...
                    options={{
                      ...salaryVsDeductionData.options,
                      plugins: {
                        ...salaryVsDeductionData.options.plugins,
                        title: {
                          display: true,
                          text: `Lương thực nhận và khấu trừ theo phòng ban (Tháng ${selectedMonth}/${selectedYear})`,
                        },
