...
import Logo from '../images/samsung-logo.jpg'; // Import logo từ thư mục imagesimport { Link, useLocation } from 'react-router-dom';
import {
  FiGrid,
  FiCalendar,
  FiDollarSign,
...
const Sidebar = () => {
  ...
  return (
    <div className="sidebar">
      <div className="logo">
        <img
          src="./pul" // Đường dẫn tương đối từ thư mục public
          alt="Samsung Logo"
          className="logo-icon"
        />
      </div>
